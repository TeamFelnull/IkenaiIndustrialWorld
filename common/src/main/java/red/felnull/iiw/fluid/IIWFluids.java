...
public class IIWFluids {
    ...
    private static IkisugiFluid register(String name, FluidProperties properties) {
        return IKSGFluidUtil.register(new ResourceLocation(IkenaiIndustrialWorld.MODID, name), properties, IIWCreativeModeTab.MOD_TAB, FLUIDS, BUCKET_ITEMS, LIQUID_BLOCKS);
    }
